...
subtest 'add an existing module' => sub {
    ...
    subtest 'existing module added' => test_add( $clone_repo, master => 'module' );
};
...
subtest 'add all' => sub {
    ...
    chdir $clone_repo->work_tree;
    run_cmd( 'add', '-a' );
    subtest 'all existing modules added' => test_add( $clone_repo, master => 'module', 'other' );
};
